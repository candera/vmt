(ns weathergen.falcon.constants
  ...
  #?(:clj (:require [weathergen.cljs.macros :refer [with-file defenum]])
     :cljs (:require-macros [weathergen.cljs.macros :refer [with-file defenum]])))
...
(with-file "mission.h"
  (defenum MissionTypeEnum           ; NOTE: This must fit int a uchar
    AMIS_NONE           = 0,
  ...
  (defenum MissionEscortConditionEnum
    AMIS_ESC_ALWAYS     = 99,
    AMIS_ESC_NONE       = 98,
    )                                    ;

  ;; Tanker conditional modes
  (defenum TankerConditionalModeEnum
    TANKER_NONE         = 0,
    TANKER_HALF         = 1,
    TANKER_FULL         = 2,
    TANKER_ALWAYS       = 3,
  ...
  (defenum MissionRequestFlagEnum
  ...
  (defenum TargetThreatReturnFlagEnum
    NEED_SEAD           = 0x01,
    NEED_ECM            = 0x02,
...
(with-file "teamdata.cpp"
  ...
  (defenum FlagImageIds ;; Flag Image IDs
    OOB_FLAGS_USA = 52000,
