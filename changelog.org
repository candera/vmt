...
Removed hack and replaced with correct code for handling database
version differences.

** v059-2

Add temporary hack to work around differences in objectives files in
Balkans and ITO (and possibly others) from KTO.

THIS VERSION WILL WORK ONLY WITH BMS RELEASE 4.35.

** v059

Updates for BMS 4.35.

THIS VERSION WILL NOT WORK WITH ANY PRIOR BMS RELEASE.
