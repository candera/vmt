...
* Change Log
** v057-52 (dev-only) [2018-09-17 Mon]
- Fix all the things I broke in the last dev release.
** v057-51 (dev-only) [2018-09-10 Mon]
- Fix typos in download page.
** v057-50 (dev-only) [2018-09-05 Wed]
- Build Linux version as well
- Change logo to 440th VFW's
- Fix various formatting problems
** v057-36 (dev-only) [2018-03-06 Tue]
...
** v057-9 (dev-only) [2018-02-02 Fri]
- Focus Tools tab when it is activated
- Improvements to damage computer
  - Remove game mechanics, add uncertainty to estimate
  - Sort to match Recon order
  - Don't list weapons that can't damage target
** v057 [2018-02-01 Thu]
